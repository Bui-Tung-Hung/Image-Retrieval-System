...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Use LoRA (Low-Rank Adaptation) for text encoder fine-tuning.",
    )
    parser.add_argument(
        "--lora-r",
        type=int,
    ...
    parser.add_argument(
        ...
        help="Comma-separated list of target modules for LoRA (in_proj,out_proj).",
    )
    parser.add_argument(
        "--save-lora-only",
        default=False,
        action='store_true',
        help="Save only LoRA adapters instead of full model (saves disk space).",
    )
    parser.add_argument(
        "--log-every-n-steps",
        type=int,
